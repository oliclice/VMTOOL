grep或glob下过滤掉.venv和.git文件,避免结果截断
...
3. `READ gitnexus://repo/VMtool/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/VMtool/context` | Codebase overview, check index freshness |
